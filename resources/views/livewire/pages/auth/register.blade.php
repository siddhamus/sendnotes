...
new #[Layout('layouts.guest')] class extends Component {
    ...
    public function register(): void
    {
        ...
        // Create the user and assign the default 'student' role
        $user = User::create($validated);
        $user->assignRole('student'); // Assign the 'student' role
        ...
        if (Auth::user()->hasRole('admin')) {
            ...
            $this->redirectIntended(default: route('courses', absolute: false), navigate: false);
        }
    }
}; ?>
            ...
            <div>
                <form wire:submit.prevent="register" class="space-y-6">
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <x-primary-button
                            class="ms-4 flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                            {{ __('Register') }}
                        </x-primary-button>
                    </div>
                </form>
