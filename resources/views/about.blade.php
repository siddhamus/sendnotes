<x-guest-layout title="About">
    <div class="min-h-full pb-32 bg-indigo-900 ">
      <main class="relative isolate">
        <!-- Background -->
        <div class="absolute inset-x-0 flex justify-center overflow-hidden top-4 -z-10 transform-gpu blur-3xl" aria-hidden="true">
        ...
        <div class="px-6 pt-14 lg:px-8">
          <div class="max-w-2xl pt-24 mx-auto text-center sm:pt-40">
        ...
        <div class="px-6 mx-auto mt-32 max-w-7xl sm:mt-40 lg:px-8">
          ...
          <dl class="grid max-w-2xl grid-cols-1 gap-8 mx-auto mt-16 text-base leading-7 text-gray-300 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-16">
        ...
        <div class="px-6 mx-auto mt-32 max-w-7xl sm:mt-40 lg:px-8">
          ...
          <ul role="list" class="grid max-w-2xl grid-cols-1 mx-auto mt-20 gap-x-8 gap-y-14 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 xl:grid-cols-4">
            <li>
        ...
        <!-- CTA section -->
        <div class="relative mt-32 isolate -z-10 sm:mt-40">
          <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex flex-col max-w-2xl gap-16 px-6 py-16 mx-auto bg-white/5 ring-1 ring-white/10 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20">
              <img class="flex-none object-cover w-full shadow-xl h-96 rounded-2xl lg:aspect-square lg:h-auto lg:max-w-sm" src="https://images.unsplash.com/photo-1519338381761-c7523edc1f46?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80" alt="">
              <div class="flex-auto w-full">
                ...
                <ul role="list" class="grid grid-cols-1 mt-10 text-base leading-7 text-white gap-x-8 gap-y-3 sm:grid-cols-2">
                  <li class="flex gap-x-3">
                    <svg class="flex-none w-5 h-7" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          ...
          <div class="absolute inset-x-0 flex justify-center overflow-hidden -top-16 -z-10 transform-gpu blur-3xl" aria-hidden="true">
