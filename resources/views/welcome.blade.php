    ...
    <div class="relative overflow-hidden bg-indigo-700">
      ...
      <div class="relative px-6 py-24 bg-indigo-700 bg-opacity-75 sm:px-6 sm:py-32 lg:px-8">
        <div class="max-w-2xl mx-auto text-center">
          <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Explore IB DP Courses<br>Enhance Your Learning Journey</h2>
          <p class="max-w-xl mx-auto mt-6 text-lg leading-8 text-indigo-200">
            Dive into our comprehensive IB DP course offerings, designed to help you achieve academic excellence and reach your full potential.
          </p>
      ...
      <div class="px-6 mx-auto max-w-7xl lg:px-8">
        <div class="max-w-2xl mx-auto lg:max-w-none">
          <div class="text-center">
            <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Your Gateway to Academic Excellence</h2>
            <p class="mt-4 text-lg leading-8 text-indigo-200">Specializing in Cambridge, IB, and SAT preparation to help you achieve your academic goals.</p>
          </div>
          <dl class="grid grid-cols-1 gap-6 mt-16 overflow-hidden text-center rounded-2xl sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="flex flex-col p-8 rounded-lg shadow-lg bg-white/10">
              ...
              <dt class="mt-2 text-sm font-semibold leading-6 text-indigo-200">Cambridge A-Level Pass Rate</dt>
            </div>
          </dl>
        </div>
      </div>
